...
app.controller('AlumnoListCtrl', ['$scope', 'AlumnoService', '$controller', '$location',
    function ($scope, service, $controller, $location) {
        ...
        $scope.eliminarNuevo = function (recurso) {
            ...
            if (window.confirm("¿Está seguro de eliminar el alumno?"))
